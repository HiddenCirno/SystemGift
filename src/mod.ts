...
class Mod implements IPreAkiLoadMod {
    ...
    private setupTraderUpdateTime(traderConfig: ITraderConfig): void {
        const traderRefreshRecord2: UpdateTime = { traderId: baseJson2._id, seconds: 3600 }
        traderConfig.updateTime.push(traderRefreshRecord2);
    }
    public SMessage(container: DependencyContainer, sessionId: String): void {
        ...
        var DailyContent = diaoluehelper.createMessageContext(DailyMessageID, MessageType.SYSTEM_MESSAGE, 24);
        var WeeklyContent = diaoluehelper.createMessageContext(WeeklyMessageID, MessageType.SYSTEM_MESSAGE, 24);
        var MonthlyContent = diaoluehelper.createMessageContext(MonthlyMessageID, MessageType.SYSTEM_MESSAGE, 24);
        var DebugContent = diaoluehelper.createMessageContext("SystemMessageDebug", MessageType.SYSTEM_MESSAGE, 24);
        var now = new Date
        var SpecialDaysStr = ""
        ...
        if (Timer[sessionId] == undefined) {
            ...
            if (SpecialDaysStr != "") {
                ...
                switch (SpecialDaysStr) {
                    case "情人节": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithValentine", MessageType.SYSTEM_MESSAGE, 24), sessionId, 情人节)
                        Tip("You have a new mail.")
                    }
                        break
                    case "圣诞节": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithChristmas", MessageType.SYSTEM_MESSAGE, 24), sessionId, 圣诞节)
                        Tip("You have a new mail.")
                    }
                        break
                    case "感恩节": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithThxgvngDay", MessageType.SYSTEM_MESSAGE, 24), sessionId, 感恩节)
                        Tip("You have a new mail.")
                    }
                        break
                    case "母亲节": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithMothersDay", MessageType.SYSTEM_MESSAGE, 24), sessionId, 母亲节)
                        Tip("You have a new mail.")
                    }
                        break
                    case "公历新年": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithNewYear", MessageType.SYSTEM_MESSAGE, 24), sessionId, 新年)
                        Tip("You have a new mail.")
                    }
                        break
                    case "万圣节": {
                        diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLoginWithHalloween", MessageType.SYSTEM_MESSAGE, 24), sessionId, 万圣节)
                        Tip("You have a new mail.")
                    }
                        break
                }
                ...
                diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageFirstLogin", MessageType.SYSTEM_MESSAGE, 24), sessionId, 每日奖励)
                Tip("You have a new mail.")
            }
        }
        //if data == true
            ...
            if (Timer[sessionId].firstlogin == true || (Date.now() - Timer[sessionId].Time) >= 86400000) {
                ...
                if (SpecialDaysStr != "") {
                    ...
                    switch (SpecialDaysStr) {
                        case "情人节": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageValentine", MessageType.SYSTEM_MESSAGE, 24), sessionId, 情人节)
                            Tip("You have a new mail.")
                        }
                            break
                        case "圣诞节": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageChristmas", MessageType.SYSTEM_MESSAGE, 24), sessionId, 圣诞节)
                            Tip("You have a new mail.")
                        }
                            break
                        case "感恩节": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageThxgvngDay", MessageType.SYSTEM_MESSAGE, 24), sessionId, 感恩节)
                            Tip("You have a new mail.")
                        }
                            break
                        case "母亲节": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageMothersDay", MessageType.SYSTEM_MESSAGE, 24), sessionId, 母亲节)
                            Tip("You have a new mail.")
                        }
                            break
                        case "公历新年": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageNewYear", MessageType.SYSTEM_MESSAGE, 24), sessionId, 新年)
                            Tip("You have a new mail.")
                        }
                            break
                        case "万圣节": {
                            diaoluehelper.addDialogueMessage("SimulationSystemTrader", diaoluehelper.createMessageContext("SystemMessageHalloween", MessageType.SYSTEM_MESSAGE, 24), sessionId, 万圣节)
                            Tip("You have a new mail.")
                        }
                            break
                    }
